    ...
    <Stage>
      <svg viewBox="0 0 800 500" className="w-full h-full">
        ...
        <motion.text
          ...
          animate={{ opacity: 1 }}
        >
          {t('frame8_2.title', { defaultValue: 'Federation' })}
        </motion.text>
        ...
        {phase >= 1 && (
          ...
          >
            ...
            <text x={400} y={215} textAnchor="middle" fill={colors.trustBundle} fontSize={11}>{t('frame8_2.trustBundleLabel', { defaultValue: 'trust bundle' })}</text>
            <text x={400} y={320} textAnchor="middle" fill={colors.trustBundle} fontSize={11}>{t('frame8_2.trustBundleLabel', { defaultValue: 'trust bundle' })}</text>
            <defs>
        ...
        {phase >= 2 && (
          ...
          >
            ...
            <text x={400} y={410} textAnchor="middle" fill="white" fontSize={14} fontWeight="bold">
              {t('frame8_2.federated', { defaultValue: 'Federated! ✓' })}
            </text>
          </motion.g>
        )}
        ...
        {phase >= 3 && (
          ...
          >
            <text x={400} y={470} textAnchor="middle" fill={colors.textSecondary} fontSize={13} fontFamily="IBM Plex Sans, sans-serif">
              {t('frame8_2.description', { defaultValue: "Domains exchange trust bundles to verify each other's SVIDs" })}
            </text>
          </motion.g>
        )}
      </svg>
