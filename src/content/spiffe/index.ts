...
export const section2: Section = {
  ...
  frames: [
    ...
    { id: '2-12', title: 'X.509 vs JWT', content: 'SVIDs come in two formats, and both are short-lived and auto-rotated. The difference is how you use them: an X.509 certificate proves identity in an mTLS handshake, while a JWT is a signed token a workload can carry through a proxy or gateway.' },
...
export const section5: Section = {
  ...
  frames: [
    ...
    { id: '5-5', title: 'The Workload API', content: 'The Workload API is a gRPC service, typically exposed over a local Unix socket. Workloads just connect to it—no credentials needed for the request itself.' },
...
export const section8: Section = {
  ...
  frames: [
    ...
    { id: '8-7', title: 'Platform Attestation: Kubernetes', content: 'Kubernetes: use Projected Service Account Tokens (PSAT)—they’re audience-scoped and short-lived. The older plain Service Account Token attestor is deprecated.' },
    ...
    { id: '8-11', title: 'OIDC Federation', content: 'SPIRE can act as an OIDC provider, so cloud IAM (like AWS STS) can validate JWT-SVIDs directly—bridging workload identity to cloud IAM.' },
